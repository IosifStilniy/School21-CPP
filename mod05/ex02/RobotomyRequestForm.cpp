...
RobotomyRequestForm::RobotomyRequestForm(RobotomyRequestForm const & src) : AForm("Presidential Pardon", 145, 137), _target(src._target)
{
}

RobotomyRequestForm::RobotomyRequestForm(std::string const & target) : AForm("Presidential Pardon", 145, 137), _target(target)
{
}
